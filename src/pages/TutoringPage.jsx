...
@media(max-width:640px){
  ...
  .tp-step-dot{width:44px!important;height:44px!important;font-size:12px!important;margin-bottom:0!important;}
      ...
      <section style={{ position: "relative", minHeight: 540, display: "flex", alignItems: "flex-end", overflow: "hidden", background: C.ink }}>
        <div style={{ position: "absolute", inset: 0, background: `linear-gradient(135deg, ${C.inkSoft} 0%, #1a1a1a 60%, ${C.maroon}30 100%)` }} />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(90deg, rgba(14,14,14,0.82) 0%, rgba(14,14,14,0.3) 70%, transparent 100%)" }} />
        <div className="tpw" style={{ position: "relative", zIndex: 2, padding: "120px clamp(24px,7vw,112px) 80px", maxWidth: 780 }}>
          <FadeIn>
            ...
            <h1 style={{ fontFamily: "'Fraunces',serif", fontSize: "clamp(34px,5vw,60px)", fontWeight: 400, color: "#fff", lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: 8 }}>
              Curriculum tutoring built around your child's schedule<br />
      ...
      {/* ══ 2. INTRO ══ */}
      <section style={{ background: C.ink, padding: "72px clamp(24px,7vw,112px)", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
        <FadeIn>
          <div style={{ borderRadius: 14, overflow: "hidden", aspectRatio: "4/3", background: `linear-gradient(160deg,${C.inkSoft} 0%,#1a1a1a 60%,${C.maroon}20 100%)`, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: "rgba(255,255,255,0.15)", letterSpacing: 2, textTransform: "uppercase" }}>Image</span>
          </div>
        </FadeIn>
        <FadeIn delay={80}>
        ...
        <div style={{ padding: "80px clamp(24px,7vw,112px) 72px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 48, alignItems: "end", marginBottom: 48 }}>
            <FadeIn>
              <h2 style={{ fontFamily: "'Fraunces',serif", fontSize: "clamp(32px,4vw,48px)", fontWeight: 300, color: C.ink, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
                Why parents & students<br />work with <em style={{ fontStyle: "italic", fontWeight: 400, color: C.maroon }}>AE tutors.</em>
              </h2>
            </FadeIn>
            <FadeIn delay={80}>
              <div style={{ borderRadius: 14, overflow: "hidden", height: 180, background: `linear-gradient(160deg,${C.creamWarm} 0%,${C.creamSoft} 100%)`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: C.stoneLight, letterSpacing: 2, textTransform: "uppercase" }}>Image</span>
              </div>
            </FadeIn>
          </div>
          <FadeIn delay={120}>
          ...
          <FadeIn delay={180}>
            <div className="tp-why-grid-bottom">
              ...
              {/* image cell */}
              <div style={{ background: C.ink, overflow: "hidden", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", minHeight: 180 }}>
                <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: "rgba(255,255,255,0.2)", letterSpacing: 2, textTransform: "uppercase" }}>Image</span>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <section style={{ background: C.ink, padding: "96px clamp(24px,7vw,112px)" }}>
        <FadeIn>
          <h2 style={{ fontFamily: "'Fraunces',serif", fontSize: "clamp(26px,3.5vw,40px)", fontWeight: 400, color: "#fff", lineHeight: 1.2, marginBottom: 40 }}>
            How we stack up <em style={{ fontStyle: "italic", color: C.accentRose }}>against the rest.</em>
          </h2>
            ...
            <tbody>
              ...
              {COMPARISON_ROWS.map((row, i) => (
                <tr className="tp-cmp-row" key={i}>
                  <td>{row.label}</td>
                  <td>{row.other === false ? <span style={{ color: C.stoneLight, fontSize: 16 }}>✕</span> : typeof row.other === "string" ? row.other : <span style={{ color: C.maroon, fontSize: 16 }}>✓</span>}</td>
                  <td>{row.ae === true ? <span style={{ color: C.maroon, fontSize: 16 }}>✓</span> : typeof row.ae === "string" ? row.ae : <span style={{ color: C.stoneLight, fontSize: 16 }}>✕</span>}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 48, gap: 24, flexWrap: "wrap" }}>
          ...
          <FadeIn delay={60}>
            <h2 style={{ fontFamily: "'Fraunces',serif", fontSize: "clamp(28px,3.5vw,44px)", fontWeight: 400, color: "#fff", lineHeight: 1.15, textAlign: "right" }}>
              Hear it from students <em style={{ fontStyle: "italic", color: C.accentRose }}>who made it.</em>
            </h2>
          </FadeIn>
        </div>
        <FadeIn delay={100}>
      ...
      <section style={{ background: C.ink, padding: "96px 0" }}>
        <div className="tpw">
          <div className="tp-faq-layout" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "start" }}>
            ...
            <FadeIn delay={120}>
              <div style={{ borderRadius: 14, overflow: "hidden", aspectRatio: "1/1", background: `linear-gradient(160deg,${C.inkSoft} 0%,#1a1a1a 50%,${C.maroon}40 100%)`, display: "flex", alignItems: "center", justifyContent: "center", minHeight: 400 }}>
                <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: "rgba(255,255,255,0.15)", letterSpacing: 1.5, textTransform: "uppercase" }}>Image</span>
              </div>
            </FadeIn>
          </div>
        </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                <div>
                  ...
                  <select value={form.countryIso} onChange={e => setField("countryIso", e.target.value)} className="te-sel" style={{ ...inpStyle(!!errors.countryIso), appearance: "none", backgroundImage: selectArrow, backgroundRepeat: "no-repeat", backgroundPosition: "right 10px center", paddingRight: 30, cursor: "pointer", color: "#fff" }}>
